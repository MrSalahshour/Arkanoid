...
public class GraphicalFastBall extends GraphicalPrize {
    private final Image image;

    public GraphicalFastBall(GraphicalPrizeBreak prizeBreak, int size,boolean available,boolean taken) {
        super(prizeBreak, size,available,taken);
        this.image = ImageLoader.getImage("fastBallPrize");
    }
