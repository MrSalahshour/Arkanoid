...
public class GraphicalDizzyBoard extends GraphicalPrize {

    private final Image image;

    public GraphicalDizzyBoard(GraphicalPrizeBreak prizeBreak, int size,boolean available,boolean taken) {
        super(prizeBreak, size,available,taken);
        this.image = ImageLoader.getImage("dizzyBoardPrize");
    }
