package ir.sharif.math.ap99_2.arkanoid.util;
...
public class Config extends Properties {
    private static final String DEFAULT_ADDRESS = "./resources/ir/sharif/math/ap99_2/arkanoid/configurations/main.properties";
