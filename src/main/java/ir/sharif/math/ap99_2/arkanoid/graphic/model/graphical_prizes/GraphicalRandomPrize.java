...
public class GraphicalRandomPrize extends GraphicalPrize {

    private final Image image;

    public GraphicalRandomPrize(GraphicalPrizeBreak prizeBreak, int size,boolean available,boolean taken) {
        super(prizeBreak, size,available,taken);
        this.image = ImageLoader.getImage("randomPrize");
    }
