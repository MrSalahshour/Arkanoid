...
public class GraphicalBigBoard extends GraphicalPrize {

    private final Image image;

    public GraphicalBigBoard(GraphicalPrizeBreak prizeBreak, int size,boolean available,boolean taken) {
        super(prizeBreak, size,available,taken);
        this.image = ImageLoader.getImage("bigBoardPrize");
    }
