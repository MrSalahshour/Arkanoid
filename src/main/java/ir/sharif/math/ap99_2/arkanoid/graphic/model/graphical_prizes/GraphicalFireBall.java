...
public class GraphicalFireBall extends GraphicalPrize {
    private final Image image;

    public GraphicalFireBall(GraphicalPrizeBreak prizeBreak, int size,boolean available,boolean taken) {
        super(prizeBreak,size,available,taken);
        this.image = ImageLoader.getImage("fireBallPrize");
    }
