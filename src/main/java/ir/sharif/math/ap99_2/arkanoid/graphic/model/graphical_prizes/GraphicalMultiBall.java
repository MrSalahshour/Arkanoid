...
public class GraphicalMultiBall extends GraphicalPrize {
    private final Image image;

    public GraphicalMultiBall(GraphicalPrizeBreak prizeBreak, int size,boolean available,boolean taken) {
        super(prizeBreak, size,available,taken);
        this.image = ImageLoader.getImage("multiBallPrize");
    }
